...
- **`kg.py`**: A python script that uses [GRAPE](https://github.com/AnacletoLAB/grape) to load and analyze the knowledge graph generated by [`sql2kg`](https://github.com/earth-metabolome-initiative/sql2kg), which represents the database schema and data.
